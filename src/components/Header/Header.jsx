...
function Header() {
  ...
  const activeLink = 'header__link active';
  ...
  return (
    <header className="header">
      ...
      <nav className="container container--pall flex flex-jc-sb flex-ai-c">
        <NavLink to="/" className="header__logo" title="EasyBank">
        ...
        <div className="header__links hide-for-mobile">
          ...
          <NavLink className={({ isActive }) => isActive ? activeLink : normalLink} to="/careers">Careers</NavLink>
        </div>
